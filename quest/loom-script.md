...
Three limits I want said out loud. The planned pair of free reviewers never ran, so this is one model family, not cross-vendor review, and I have recorded it as incomplete rather than dressing it up. A cluster's statement is still the model's own text and is not grounded. And three synthetic cases prove the hole is closed, not that it ever hurt anyone in production. What I can defend is narrower and better than what I could claim."
