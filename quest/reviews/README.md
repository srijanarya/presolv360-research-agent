...
| `06-terra-blind-assessment-b088b68.md`, `06-terra-blind-assessment-manifest.json` | 6, `gpt-5.6-terra` blind assessment | `b088b68` | full response and the snapshot manifest (file list, sha256 `7681e748…`) |
